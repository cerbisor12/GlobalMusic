...
/**
 * Class that creates the initial window for the event organizer after logging in
 *
 */
public class OrganizerAddEventView {
	 ...
	 private JList addedPerfList;
	    ...
	    private void initialize() {
	        ...
	        //Create objects to get/alter data in the database
	        User user = new User();
	        ...
	        //if the user selects to add a new venue, loads NewVenueView frame
			...
			//Check if entered value is a double
			...
			/*
			Load a JFileChooser restricted only on image files and copy selected image to the project directory
			Also updade the imageLabel accordingly for later checking
			 */
			...
			//Model for allPerformers list, populated with all performers from the database
			...
			//Static list including all performers to be edited outside the class
			...
			//Model for added Performers list
	        ...
	        //Adds selected performer from allPerformers List to addedPerformersList
	        ...
	        //Removes selected performer from addedPerformers List
	        ...
	        //Create a new event record and respective event_band records in the database after validating all fields are filled
	...
	/**
	 * Returns true if all conditions are met, else shows appropriate pop up dialog
 	 * @return boolean
	 */
